...
func TestLinkShortenerCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.LinkShortener.Create(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestLinkShortenerCreateWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestLinkShortenerCreateWithWireMock", "POST", "/v1/short-links", nil, 1)
}
