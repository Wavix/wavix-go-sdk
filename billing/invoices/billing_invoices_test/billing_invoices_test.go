...
func TestBillingInvoicesListWithWireMock(
	...
	_, invocationErr := client.Billing.Invoices.List(
		context.TODO(),
		request,
	...
	VerifyRequestCount(t, "TestBillingInvoicesListWithWireMock", "GET", "/v1/billing/invoices", map[string]interface{}{"page": "1", "per_page": "25"}, 1)
}
