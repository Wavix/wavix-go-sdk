...
package billing_transactions_test
...
func TestBillingTransactionsListWithWireMock(
	...
	_, invocationErr := client.Billing.Transactions.List(
		context.TODO(),
		request,
	...
	VerifyRequestCount(t, "TestBillingTransactionsListWithWireMock", "GET", "/v1/billing/transactions", map[string]interface{}{"from_date": "2023-08-01", "to_date": "2023-08-31", "details_contains": "monthly", "payments": "true", "page": "1", "per_page": "25"}, 1)
}
