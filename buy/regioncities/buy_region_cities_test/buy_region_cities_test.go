...
package buy_region_cities_test
...
func TestBuyRegionCitiesListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Buy.RegionCities.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestBuyRegionCitiesListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestBuyRegionCitiesListWithWireMock", "GET", "/v1/buy/countries/1891/regions/821/cities", nil, 1)
}
