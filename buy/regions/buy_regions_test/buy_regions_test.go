...
func TestBuyRegionsListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Buy.Regions.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestBuyRegionsListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestBuyRegionsListWithWireMock", "GET", "/v1/buy/countries/1892/regions", nil, 1)
}
