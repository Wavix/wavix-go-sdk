...
func TestBuyNumbersListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Buy.Numbers.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestBuyNumbersListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestBuyNumbersListWithWireMock", "GET", "/v1/buy/countries/1/cities/1/dids", nil, 1)
}
