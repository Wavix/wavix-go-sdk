...
func TestNumbersPapersUploadWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Numbers.Papers.Upload(
		...
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestNumbersPapersUploadWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestNumbersPapersUploadWithWireMock", "POST", "/v1/numbers/papers", nil, 1)
}
