...
func (r *RawClient) Create(
...
) (*core.Response[*wavixgosdk.CallStreamResponse], error) {
	...
	var response *wavixgosdk.CallStreamResponse
	...
	return &core.Response[*wavixgosdk.CallStreamResponse]{
