...
func (r *RawClient) List(
...
) (*core.Response[*wavixgosdk.SipTrunkListResponse], error) {
	...
	var response *wavixgosdk.SipTrunkListResponse
	...
	return &core.Response[*wavixgosdk.SipTrunkListResponse]{
...
func (r *RawClient) Create(
	...
	opts ...option.RequestOption,
) (*core.Response[*wavixgosdk.SipTrunkResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	var response *wavixgosdk.SipTrunkResponse
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*wavixgosdk.SipTrunkResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
